...
export function CategoryDistribution({
  ...
  useEffect(() => {
    ...
    const newChartData = {
      ...
      datasets: [{
        ...
        backgroundColor: categories.map((_, index) => colorMap[index % 6] || '#6B7280'),
        borderWidth: 0
      }]
    };
  ...
  }, [expenseCategories, incomeCategories, selectedCategoryType]);
  ...
  return (
    <div className="chart-card">
      ...
      <div className="legend-container">
        {!isLoading && chartData.labels.map((label, index) => {
