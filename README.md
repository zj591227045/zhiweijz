...
### 新增功能
- 🗄️ **统一计划任务调度器**: 整合计划任务，集成统一的计划任务调度器
- 📊 **仪表盘无限加载**: 仪表盘页面的记账记录支持无限加载，提升大数据浏览体验
- ⬆️ **一键返回顶部**: 为仪表盘页面添加快捷按钮，一键返回顶部
- 💾 **自动备份功能**: 在计划任务中增加后端数据库以及对象存储一键备份功能

### 问题修复
- 🗑️ **过期用户删除**: 修复过期删除注销用户失败的问题
...
### 历史版本
- 📋 [v0.8.0 更新日志](docs/version/v0.8.0-changelog.md) - 图片识别多记录选择导入、安卓快捷记账、分摊功能、火山方舟大模型等
...
# 镜像版本（可根据需要切换版本）
BACKEND_IMAGE_VERSION=0.9.0
FRONTEND_IMAGE_VERSION=0.9.0
NGINX_IMAGE_VERSION=0.9.0
```
