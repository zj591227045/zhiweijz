...
const MIGRATIONS_CONFIG = {
  ...
  UPGRADE_PATHS: {
    ...
    '1.7.10': ['fix-budget-schema', 'add-family-member-custodial-fields', 'fix-invitations-table', 'add-budget-unique-constraint', 'add-version-management', 'add-detail-url-to-app-versions', '1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.7.11': ['add-family-member-custodial-fields', 'fix-invitations-table', 'add-budget-unique-constraint', 'add-version-management', 'add-detail-url-to-app-versions', '1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.7.12': ['fix-invitations-table', 'add-budget-unique-constraint', 'add-version-management', 'add-detail-url-to-app-versions', '1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.7.13': ['add-budget-unique-constraint', 'add-version-management', 'add-detail-url-to-app-versions', '1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.7.14': ['add-version-management', 'add-detail-url-to-app-versions', '1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.7.15': ['add-detail-url-to-app-versions', '1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.7.16': ['1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.7.17': ['1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    'add-budget-unique-constraint': ['1.8.0-expand-membership-system', 'update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.8.0': ['update-smart-accounting-prompts-v1.8.1'], // 升级到1.8.1
    '1.8.1': [], // 当前最新版本
