...
const MIGRATIONS_CONFIG = {
  ...
  UPGRADE_PATHS: {
    ...
    '1.4.0': ['fix-missing-account-book-id-fields', '1.4.0-to-1.5.0', '1.5.0-to-1.6.0', 'add-file-storage', 'add-multimodal-ai-configs', 'fix-webm-audio-format', 'add-smart-accounting-prompts', 'add-accounting-points-system', 'add-last-daily-gift-date', 'add-membership-system', 'add-payment-system', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    ...
    '1.7.3': ['fix-missing-account-book-id-fields', 'add-accounting-points-system', 'add-last-daily-gift-date', 'add-membership-system', 'add-payment-system', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    '1.7.4': ['fix-missing-account-book-id-fields', 'add-last-daily-gift-date', 'add-membership-system', 'add-payment-system', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    '1.7.5': ['fix-missing-account-book-id-fields', 'add-membership-system', 'add-payment-system', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    '1.7.6': ['fix-missing-account-book-id-fields', 'add-payment-system', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema', 'add-family-member-custodial-fields'], // 升级到1.7.12
    '1.7.7': ['fix-missing-account-book-id-fields', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema', 'add-family-member-custodial-fields'], // 升级到1.7.12
    '1.7.8': ['fix-missing-account-book-id-fields', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema', 'add-family-member-custodial-fields'], // 升级到1.7.12
    'add-image-compression-configs': ['fix-missing-account-book-id-fields', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema', 'add-family-member-custodial-fields'], // 升级到1.7.12
    'add-compression-stats-table': ['fix-missing-account-book-id-fields', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema', 'add-family-member-custodial-fields'], // 升级到1.7.12
    'ai-service-management-restructure': ['fix-missing-account-book-id-fields', 'fix-daily-gift-concurrency', 'fix-budget-schema', 'add-family-member-custodial-fields'], // 升级到1.7.12
    '1.7.9': ['fix-missing-account-book-id-fields', 'fix-daily-gift-concurrency', 'fix-budget-schema', 'add-family-member-custodial-fields'], // 升级到1.7.12
    '1.7.10': ['fix-budget-schema', 'add-family-member-custodial-fields'], // 升级到1.7.12
    '1.7.11': ['add-family-member-custodial-fields'], // 升级到1.7.12
    '1.7.12': [], // 当前最新版本
    'fresh_install': ['base-schema', 'fix-missing-account-book-id-fields', 'admin-features', '1.1.0-to-1.2.0', '1.2.2-to-1.3.0', 'add-service-type-to-llm-call-logs', 'add-transaction-metadata', 'add-wechat-integration', 'add-user-deletion-fields-v2', '1.4.0-to-1.5.0', '1.5.0-to-1.6.0', 'add-file-storage', 'add-multimodal-ai-configs', 'fix-webm-audio-format', 'add-smart-accounting-prompts', 'add-accounting-points-system', 'add-last-daily-gift-date', 'add-membership-system', 'add-payment-system', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema', 'add-family-member-custodial-fields']
  }
};
