...
const MIGRATIONS_CONFIG = {
  ...
  UPGRADE_PATHS: {
    ...
    '1.7.6': ['fix-missing-account-book-id-fields', 'add-payment-system', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    '1.7.7': ['fix-missing-account-book-id-fields', 'add-image-compression-configs', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    '1.7.8': ['fix-missing-account-book-id-fields', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    'add-image-compression-configs': ['fix-missing-account-book-id-fields', 'add-compression-stats-table', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    'add-compression-stats-table': ['fix-missing-account-book-id-fields', 'ai-service-management-restructure', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    'ai-service-management-restructure': ['fix-missing-account-book-id-fields', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    '1.7.9': ['fix-missing-account-book-id-fields', 'fix-daily-gift-concurrency', 'fix-budget-schema'], // 升级到1.7.11
    '1.7.10': ['fix-budget-schema'], // 升级到1.7.11
    '1.7.11': [], // 当前最新版本
