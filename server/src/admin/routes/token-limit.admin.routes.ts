...
router.put(
  '/global/settings',
  tokenLimitController.updateGlobalSettings.bind(tokenLimitController),
);
...
router.post(
  '/users/batch-set-limits',
  tokenLimitController.batchSetUserTokenLimits.bind(tokenLimitController),
);
