...
-- 生成时间: Wed May 28 00:46:32 CST 2025
...
ALTER TABLE ONLY public.account_books
ALTER TABLE ONLY public.account_books
    ADD CONSTRAINT account_books_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.account_books
ALTER TABLE ONLY public.account_llm_settings
    ADD CONSTRAINT account_llm_settings_account_book_id_fkey FOREIGN KEY (account_book_id) REFERENCES public.account_books(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.budget_histories
    ADD CONSTRAINT budget_histories_budget_id_fkey FOREIGN KEY (budget_id) REFERENCES public.budgets(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.budgets
ALTER TABLE ONLY public.budgets
ALTER TABLE ONLY public.budgets
ALTER TABLE ONLY public.budgets
...
ALTER TABLE ONLY public.categories
ALTER TABLE ONLY public.category_budgets
    ADD CONSTRAINT category_budgets_budget_id_fkey FOREIGN KEY (budget_id) REFERENCES public.budgets(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.category_budgets
    ADD CONSTRAINT category_budgets_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.families
    ADD CONSTRAINT families_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.family_members
    ADD CONSTRAINT family_members_family_id_fkey FOREIGN KEY (family_id) REFERENCES public.families(id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.family_members
ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT invitations_family_id_fkey FOREIGN KEY (family_id) REFERENCES public.families(id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.password_reset_tokens
...
ALTER TABLE ONLY public.user_category_configs
    ADD CONSTRAINT user_category_configs_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.user_category_configs
    ADD CONSTRAINT user_category_configs_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.user_feedback
ALTER TABLE ONLY public.user_feedback
...
ALTER TABLE ONLY public.user_llm_settings
    ADD CONSTRAINT user_llm_settings_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.user_settings
