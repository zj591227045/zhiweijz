...
export function SettingsBudgetListPage() {
  ...
  const handleAddBudget = () => {
    router.push('/settings/budgets/add');
  };
  ...
  return (
    ...
    >
      ...
      <div className="statistics-link-container">
        <button className="statistics-link" onClick={() => router.push('/settings/budgets/statistics')}>
