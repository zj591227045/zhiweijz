        ...
        <div className="main-content" style={{
          ...
          {isLoading ? (
            ...
            <div style={{ padding: '0 20px' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        fontWeight: '600',
                        marginBottom: '4px'
                      }}>{formData.name || '账本名称'}</div>
                      <div style={{
                        fontSize: '14px',
                        opacity: 0.9,
                        marginBottom: '8px'
                      }}>{formData.description || '账本描述'}</div>
                      <div style={{
                        display: 'flex',
                        gap: '8px',
                        flexWrap: 'wrap'
              ...
              {/* 功能设置组 */}
              <div style={{ marginBottom: '80px' }}> {/* 增加底部边距，确保不被保存按钮遮挡 */}
                <div style={{
                  fontSize: '16px',
                  fontWeight: '600',
                  color: 'var(--text-secondary)',
                  ...
                  <div style={{
                    ...
                    <label style={{
                      ...
                      <span style={{
                        ...
                        right: 0,
                        bottom: 0,
                        backgroundColor: formData.isDefault ? 'var(--primary-color)' : 'var(--border-color)',
                        transition: '0.3s',
                        borderRadius: '24px'
                      }}>
                        <span style={{
