        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              height: '40px',
              borderRadius: '10px',
              backgroundColor: isAIEnabled ? 'rgba(59, 130, 246, 0.1)' : 'rgba(107, 114, 128, 0.1)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center'
            }}>
              <i className="fas fa-robot" style={{
                fontSize: '20px',
                color: isAIEnabled ? 'var(--primary-color, rgb(59, 130, 246))' : 'var(--text-secondary, rgb(107, 114, 128))'
              }}></i>
            </div>
            <div>
              <h3 style={{
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  fontSize: '12px',
                  fontWeight: '500',
                  backgroundColor: isAIEnabled ? 'rgba(34, 197, 94, 0.1)' : 'rgba(239, 68, 68, 0.1)',
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                height: '48px',
                borderRadius: '12px',
                backgroundColor: activeService?.type === 'official' ? 'rgba(59, 130, 246, 0.1)' : 'rgba(139, 69, 19, 0.1)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center'
              }}>
                <i className={activeService?.type === 'official' ? 'fas fa-cloud' : 'fas fa-cog'} style={{
                  fontSize: '24px',
                  color: activeService?.type === 'official' ? 'var(--primary-color, rgb(59, 130, 246))' : 'rgb(139, 69, 19)'
                }}></i>
              </div>
              <div style={{ flex: 1 }}>
                <h4 style={{
                  ...
                  {activeService?.name || (activeService?.type === 'official' ? '只为记账官方AI服务' : '自定义AI服务')}
                </h4>
                <p style={{
                  fontSize: '14px',
                  color: 'var(--text-secondary, rgb(107, 114, 128))',
                  ...
                  {activeService?.type === 'custom' && activeService?.provider && activeService?.model && (
                    <span> · {activeService.provider} · {activeService.model}</span>
                  )}
                </p>
