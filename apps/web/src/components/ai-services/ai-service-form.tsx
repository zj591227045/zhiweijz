  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="ai-service-form space-y-6">
      <div className="form-group">
        <label htmlFor="name" className="form-label">服务名称</label>
        <input
          id="name"
          type="text"
          {...register("name")}
      ...
      <div className="form-group">
        <label htmlFor="provider" className="form-label">服务提供商</label>
        <select
          id="provider"
          {...register("provider")}
        ...
        {errors.provider && <div className="text-red-500 text-xs mt-1">{errors.provider.message}</div>}
      </div>

      {selectedProvider && (
        <div className="form-group">
          <label htmlFor="model" className="form-label">模型名称</label>
          <select
            id="model"
            {...register("model")}
        ...
        {showAdvancedSettings && (
          <div className="advanced-content space-y-4 mt-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="form-group">
                <label htmlFor="maxTokens" className="form-label">最大Token数</label>
                <input
                  id="maxTokens"
                  type="number"
                  step="100"
            ...
            <div className="form-group">
              <label htmlFor="description" className="form-label">描述（可选）</label>
              <textarea
                id="description"
